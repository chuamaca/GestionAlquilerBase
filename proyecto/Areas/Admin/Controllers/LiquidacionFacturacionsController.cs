...
namespace proyecto.Areas.Admin.Controllers
{
    ...
    public class LiquidacionFacturacionsController : Controller
    {
        ...
        public ActionResult GenerarActaConformidad()
        {
            return View();
        }
        ...
        public bool EvenGenerarActa(string numerofactura, string firma)
        {
            ...
            try
            {
                ...
                formatoacta.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, "D:/netcorporate.net/rentt/reports/acta/ActaConformidad" + numerofactura.ToString() + ".pdf");
